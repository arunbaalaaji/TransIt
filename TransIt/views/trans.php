...
<div class="w3-container" style="padding:50px 16px" id="action">
  <h3 class="w3-center w3-xxxlarge"><i class="fa fa-send"></i> Transfer money</h3>
  <p class="w3-center w3-xlarge">Let the transaction begin . . .</p>
  <center>
...
<center>
<form class="w3-container" action="../controller/transaction.php" method="post">
  <div class="container">
  <table cellspacing="0" cellpadding="10">

  <tr>
    <td>
      <label class="w3-large"><b>To id </b></label>
    </td>
    <td>
      <input class ="w3-input" type="text" placeholder="Enter To id  " name="to" style="width:150%" required autofocus>
    </td>
  </tr>
  ...
  <br/>     
    <button class="w3-button w3-green w3-round-large" style="width:10%">Transfer</button>
  </div>
